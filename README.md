...
3. Create Azure environment by commit and tag "aks-init-env*"
   ...
   ```
5. Check progress on tab "action" until it finished. <img src="img/aks1.png" alt="githubaction" width="400" height="200">(Optional: Verify result on web console/cli for double check)
